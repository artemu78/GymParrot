...
describe('Performance Benchmarks', () => {
  ...
  describe('Memory Usage Optimization', () => {
    it('should handle large pose sequences without memory issues', () => {
      ...
      const startMemory = perfWithMemory.memory ? perfWithMemory.memory.usedJSHeapSize : 0;
      ...
      const endMemory = perfWithMemory.memory ? perfWithMemory.memory.usedJSHeapSize : 0;
